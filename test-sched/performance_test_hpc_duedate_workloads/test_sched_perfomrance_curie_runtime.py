...
# _test_buffer = open("./plot-slowdown/plot-slowdown-curie-0-mics.dat", "w+")
# _test_buffer = open("./plot-lateness/plot-lateness-curie-75-mics.dat", "w+")
_test_buffer = open("./plot-throughput/plot-throughput-curie-25-mics.dat", "w+")
...
# show the end
print('Boxplot saved in file plot-throughput/')
