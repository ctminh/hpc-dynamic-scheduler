...
model_num_nodes = []
model_num_mics = []         # for mic nodes
model_run_times = []
model_submit_times = []
model_duedate_times = []    # for duedate values
num_tasks_queue = 32
num_tasks_state = 16
earliest_submit = 0
tasks_state_nodes = []
tasks_state_mics = []       # for mic nodes
tasks_state_runtimes = []
tasks_state_submit = []
tasks_state_duedate = []    # for duedate values
tasks_queue_nodes = []
tasks_queue_mics = []       # for mic nodes
...
# _test_buffer = open("./plot-lateness/plot-lateness-anl-75-mics.dat", "w+")
# _test_buffer = open("./plot-slowdown/plot-slowdown-anl-25-mics.dat", "w+")
_test_buffer = open("./plot-throughput/plot-throughput-anl-25-mics.dat", "w+")
for i in xrange(0, NUM_EXPERIMENTS):
