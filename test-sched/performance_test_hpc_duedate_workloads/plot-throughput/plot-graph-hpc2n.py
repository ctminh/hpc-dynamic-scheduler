...
# filename = "./plot-lateness-hpc2n-0-mics.dat"
filename = "./plot-throughput-hpc2n-25-mics.dat"
...
plt.savefig('figures/throughput-hpc2n-25-mic.pdf', format='pdf', dpi=1000, bbox_inches='tight')
print('Boxplot saved in figures/')
# save image to file - for lateness
# plt.savefig('figures/lateness-hpc2n-0-mic.pdf', format='pdf', dpi=1000, bbox_inches='tight')
# print('Boxplot saved in figures/')
