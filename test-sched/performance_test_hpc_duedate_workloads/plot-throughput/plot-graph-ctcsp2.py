...
filename = "./plot-throughput-ctcsp2-25-mics.dat"
...
plt.savefig('figures/throughput-ctcsp2-25-mic.pdf', format='pdf', dpi=1000, bbox_inches='tight')
print('Boxplot saved in figures/')
# save image to file - for lateness
# plt.savefig('figures/lateness-ctcsp2-0-mic.pdf', format='pdf', dpi=1000, bbox_inches='tight')
# print('Boxplot saved in figures/')
