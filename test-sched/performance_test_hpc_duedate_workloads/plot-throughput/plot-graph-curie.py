...
# filename = "./plot-lateness-curie-0-mics.dat"
filename = "./plot-throughput-curie-25-mics.dat"
...
plt.savefig('figures/throughput-curie-25-mic.pdf', format='pdf', dpi=1000, bbox_inches='tight')
print('Boxplot saved in figures/')
# save image to file - for lateness
# plt.savefig('figures/lateness-curie-0-mic.pdf', format='pdf', dpi=1000, bbox_inches='tight')
# print('Boxplot saved in figures/')
