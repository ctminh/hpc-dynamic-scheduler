...
# filename = "./plot-lateness-anl-75-mics.dat"
filename = "./plot-throughput-anl-25-mics.dat"
...
# plt.savefig('figures/slowdown-supernode-xp.pdf', format='pdf', dpi=1000, bbox_inches='tight')
# print('Boxplot saved in file slowdown-supernode-xp.pdf')
# save image to file - for throughput
plt.savefig('figures/throughput-anl-25-mic.pdf', format='pdf', dpi=1000, bbox_inches='tight')
print('Boxplot saved in figures/')
# save image to file - for lateness
# plt.savefig('figures/lateness-anl-75-mic.pdf', format='pdf', dpi=1000, bbox_inches='tight')
# print('Boxplot saved in figures/')
