...
for i in xrange(0, NUM_EXPERIMENTS):  # 1e7
    ...
    subprocess.call(['./sched-simulator-runtime simgrid-xmls/plat_day.xml simgrid-xmls/deployment_hpc2n.xml -unicef -nj ' +
                     str(number_of_tasks)], shell=True, stdout=_buffer)
    # subprocess.call(['./sched-simulator-runtime simgrid-xmls/plat_day.xml xmls/deployment_hpc2n.xml -edd -nj ' +
    #                  str(number_of_tasks)], shell=True, stdout=_buffer)
    # subprocess.call(['./sched-simulator-runtime simgrid-xmls/plat_day.xml xmls/deployment_hpc2n.xml -easy -nj ' +
    #                  str(number_of_tasks)], shell=True, stdout=_buffer)
    # subprocess.call(['./sched-simulator-runtime simgrid-xmls/plat_day.xml xmls/deployment_hpc2n.xml -f1 -nj ' +
    #                  str(number_of_tasks)], shell=True, stdout=_buffer)
    # subprocess.call(['./sched-simulator-runtime simgrid-xmls/plat_day.xml xmls/deployment_hpc2n.xml -f2 -nj ' +
    #                  str(number_of_tasks)], shell=True, stdout=_buffer)
    # subprocess.call(['./sched-simulator-runtime simgrid-xmls/plat_day.xml xmls/deployment_hpc2n.xml -f3 -nj ' +
    #                  str(number_of_tasks)], shell=True, stdout=_buffer)
    # subprocess.call(['./sched-simulator-runtime simgrid-xmls/plat_day.xml xmls/deployment_hpc2n.xml -f4 -nj ' +
    #                  str(number_of_tasks)], shell=True, stdout=_buffer)
    _buffer.close()
...
plt.savefig('plots/sched_perf_on_hpc2n_runtime.pdf', format='pdf',
...
# show the end
print('Boxplot saved in file plots/sched_perf_on_hpc2n_runtime.pdf')
